        ...
        <section className="mx-auto my-6 flex max-w-5xl flex-col gap-6 px-4 sm:px-0">
            ...
            >
                ...
                <article id="definitions" className="flex flex-col gap-4">
                    ...
                    <ol className="ml-4 flex list-inside list-decimal flex-col gap-2">
                        ...
                        <li>
                            <strong className="font-bold">Device</strong> means
                            any device that can access the Service such as a
                            computer, a cellphone or a digital tablet.
                        </li>
                        <li>
                            <strong className="font-bold">Personal Data</strong>{" "}
                        ...
                        <li>
                            ...
                            refers to Birdy, accessible from{" "}
                            <a
                        ...
                        <li>
                            <strong className="font-bold">You</strong> means the
            ...
            <div id="childrens-privacy" className="flex flex-col gap-4">
                ...
                <article className="flex flex-col gap-4">
                    ...
                    <strong className="font-bold">
                        THIS WEBSITE DOES NOT PROVIDE ITS SERVICES TO
                        INDIVIDUALS UNDER THE AGE OF 18! IF WE SUSPECT
                        YOU&apos;RE A MINOR, WE WILL TERMINATE YOUR ACCOUNT
                        IMMIDEATLY! (By terminate, we mean complete deletion).
                    </strong>
                </article>
            </div>
