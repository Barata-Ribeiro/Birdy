...
export class Default1695642784250 implements MigrationInterface {
    name = 'Default1695642784250'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "user_likes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "likedAt" TIMESTAMP NOT NULL DEFAULT now(), "user_id" uuid, "photo_id" uuid, CONSTRAINT "PK_766a84015341ed59620e2542747" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "user_likes" ADD CONSTRAINT "FK_7392cc61e4d0e57d0c02fafdc72" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_likes" ADD CONSTRAINT "FK_5144ff8d65a4f6efe9abd2a1072" FOREIGN KEY ("photo_id") REFERENCES "photos"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_likes" DROP CONSTRAINT "FK_5144ff8d65a4f6efe9abd2a1072"`);
        await queryRunner.query(`ALTER TABLE "user_likes" DROP CONSTRAINT "FK_7392cc61e4d0e57d0c02fafdc72"`);
