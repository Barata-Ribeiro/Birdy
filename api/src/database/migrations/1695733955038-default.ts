...
export class Default1695733955038 implements MigrationInterface {
    name = 'Default1695733955038'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "user_likes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" uuid NOT NULL, "photoId" uuid NOT NULL, "likedAt" TIMESTAMP NOT NULL DEFAULT now(), "isActive" boolean NOT NULL DEFAULT true, CONSTRAINT "UQ_cf89399f12f9c6c8e3c96710fc4" UNIQUE ("userId", "photoId"), CONSTRAINT "PK_766a84015341ed59620e2542747" PRIMARY KEY ("id"))`);
